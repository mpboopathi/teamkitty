...
// Shows only entries the current user is plausibly allowed to act on:
// they didn't create it (self-acknowledgement is blocked server-side
// anyway, but hiding it here avoids a confusing button that errors).
export function PendingApprovals({ entries, currentUserId, onChanged }: Props) {
